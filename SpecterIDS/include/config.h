...
typedef struct {
    ...
    char pcap_file[SPECTERIDS_PATH_LEN];
    char sqlite_path[SPECTERIDS_PATH_LEN];
    char plugin_dir[SPECTERIDS_PATH_LEN];
    char plugin_paths[SPECTERIDS_LIST_LEN];
    ...
    char beaconing_whitelist[SPECTERIDS_LIST_LEN];
    ...
    int snaplen;
    int metrics_port;
    int beaconing_min_hits;
    int beaconing_interval;
    int beaconing_tolerance;
